...
<head runat="server">
    ...
    <script language="C#" runat="server">
        ...
        protected void Submit(object sender, EventArgs e)
        {
            ...
            {
                Display.InnerHtml = "Password length should be atleast 5 characters";
                UserPassword.Focus();
                return;
            }
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select  * from [Customer] where c_email_id=@email and c_password=@password", con);
                ...
                while(dr.Read())
                {
                    ...
                    {    
                        Session["s1"] = "1";
                        Session["cemail"] = UserEmail.Value ;
